...
const NavLinks = ({handleNav}) => {
  return (
    <ul className='nav-links'>
        <li onClick={handleNav} ><Link  to="//twitter.com/PeaceJinadu" target='_blank' className='nav-link'><FaTwitter /></Link></li>
        <li onClick={handleNav} ><Link  to="//www.linkedin.com/in/peace-jinadu-paul-484356160" target='_blank' className='nav-link'><FaLinkedin /></Link></li>
